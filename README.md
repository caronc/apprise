...
| [Threema](https://github.com/caronc/apprise/wiki/Notify_threema) | threema://  | (TCP) 443   | threema://userid@secret<br/>threema://user@secret/ToPhoneNo<br/>threema://user@secret/ToEmail<br/>threema://user@secret/ToUser/<br/>threema://user@secret/ToEmail/ToUser/ToPhoneNo/...
